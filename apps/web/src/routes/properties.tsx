...
export const Route = createFileRoute("/properties")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Browse Homes for Rent & Sale | Viva Homes" },
      {
        property: "og:description",
        content: "Filter by city, price, bedrooms and property type to find your next home in Ethiopia.",
      },
    ],
  }),
    ...
    () =>
      listings.filter((l) => {
        ...
        if (query) {
          ...
          if (
            !`${l.title} ${l.area} ${l.city} ${l.type}`.toLowerCase().includes(q)
          )
            return false;
        }
        return true;
