...
export const Route = createFileRoute("/list-property")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "List Your Property | Viva Homes" },
      {
        property: "og:description",
        content: "Publish a verified listing in minutes and speak with serious renters and buyers directly.",
      },
    ],
  }),
